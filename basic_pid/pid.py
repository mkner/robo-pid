...
class BasicPid(Object):
     ...
     def __init__(self):
       ...
       self._vers = "v0.01.11a0 from dev v0.01.07b"
       self._about = "was PidNew07(Object):"
          
#class PidNew07(Object):
#    # BPPC - Basic Python PID Controller  
#     def __init__(self):
#       super(PidNew07, self).__init__()
#       self._name = "Pid"
#       self._desc = "BPPC - Basic Python PID Controller"
#       self._vers = "v0.01.07b"
